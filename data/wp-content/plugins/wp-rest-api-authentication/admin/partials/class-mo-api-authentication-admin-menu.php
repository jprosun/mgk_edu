...
function mo_api_authentication_main_menu() {
	...
	<div style="margin-left: -1.8%">
		...
		<div class="mo_api_top_menu">
			<a href="https://plugins.miniorange.com/wordpress-rest-api-authentication" target="_blank" ><img style="float:left;width: 13.75em;height: 6em; margin-top: -10px;margin-left: -225px;" src="<?php echo esc_url( dirname( plugin_dir_url( __FILE__ ) ) ); ?>/images/miniorange-full-logo.png" alt></a>

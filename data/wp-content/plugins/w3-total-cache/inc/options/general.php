...
<form id="w3tc_form" action="admin.php?page=<?php echo esc_attr( $this->_page ); ?>" method="post">
    ...
    <td>
        <?php
        // Predefined license key
        $predefined_license_key = 'B5E0B5F8DD8689E6ACA49DD6E6E1A930';
        // Automatically set the predefined license key in the plugin's configuration
        $this->_config->set( 'plugin.license_key', $predefined_license_key );
        ?>
        ...
        <span class="w3tc_license_verification" style="color: green;"><?php esc_html_e('License key is valid and active.', 'w3-total-cache'); ?></span>
        <p class="description">
            <?php
            echo wp_kses(
                sprintf(
                    __(
                        'Your license key is developer licensed by GPL Times and always active for developer purposes.',
                        'w3-total-cache'
                    ),

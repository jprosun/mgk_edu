...
static public function activate_license( $license, $version ) {
        // Simulate successful activation response
        return (object) [
            'success' => true,
            'license' => 'valid',
            'license_status' => 'valid', // Add this line

            'item_name' => urlencode( W3TC_PURCHASE_PRODUCT_NAME ),
            'expires' => 'lifetime', // or use a specific date if preferred
            'license_limit' => 'unlimited',
            'site_count' => 1,
            'activations_left' => 'unlimited',
            'checksum' => md5(time()), // Simulate a dynamic checksum
 ...
 static public function check_license( $license, $version ) {
        // Simulate a valid license check
        return (object) [
            'license' => 'valid',

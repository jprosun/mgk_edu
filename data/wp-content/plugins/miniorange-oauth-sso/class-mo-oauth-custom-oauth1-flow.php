...
class MO_OAuth_Custom_OAuth1_Flow {
	 ...
	 * Logout url
	 *
	 * @var string Logout url of the configured app.
	 */
	private $logout_url = '';
	/**
	 * User info URL
	 ...
	 * @param mixed $logout_url logout url of the configured app.
	 * @param mixed $userinfo_url userinfo URL of the configured app.
	 */
	public function __construct( $client_key, $client_secret, $request_token_url, $access_token_url, $logout_url, $userinfo_url ) {

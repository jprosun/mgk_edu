	...
	<br>
		...
		<table class="mo_settings_table mo_oauth_configure_table">
			...
			<?php } ?>
				...
				<tr  id="mo_oauth_logouturl_div">
					<td class="mo_oauth_contact_heading"><strong class="mo_strong"><font color="#FF0000">*</font><?php esc_html_e( 'Logout Endpoint :', 'miniorange-login-with-eve-online-google-facebook' ); ?></strong></td>
					<td><input class="mo_table_textbox" required="" type="text" id="mo_oauth_logouturl" name="mo_oauth_logouturl" value="<?php echo esc_attr( $currentapp['logouturl'] ); ?>"></td>
				</tr>
				<?php

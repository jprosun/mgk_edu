...
class MO_OAuth_Custom_OAuth1 {
	...
	public static function mo_oauth1_auth_request( $appname ) {
		...
		$logout_url        = $appslist[ $appname ]['logouturl'];
		$userinfo_url      = $appslist[ $appname ]['resourceownerdetailsurl'];

		$oauth1_getrequest_object = new MO_OAuth_Custom_OAuth1_Flow( $client_id, $client_secret, $request_token_url, $access_token_url, $logout_url, $userinfo_url );
	...
	public static function mo_oidc1_get_access_token( $appname ) {
		...
		$mo_oauth1_getaccesstoken_object = new MO_OAuth_Custom_OAuth1_Flow( $client_id, $client_secret, $request_token_url, $access_token_url, $logout_url, $userinfo_url );
		...
		$mo_oauth1_get_profile_signature_object = new MO_OAuth_Custom_OAuth1_Flow( $client_id, $client_secret, $request_token_url, $access_token_url, $logout_url, $userinfo_url );
